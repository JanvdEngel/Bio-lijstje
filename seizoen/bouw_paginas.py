...
def overpagina(data):
  ...
  <section class="group">
    ...
    <div class="prose">
      <p>Gemaakt en onderhouden door Jan van den Engel, naast mijn werk vanuit
      <a href="https://www.styrinth.nl/" rel="noopener">Styrinth</a>. Het draait
      op een Raspberry Pi bij mij thuis, die elke ochtend de data ophaalt en
